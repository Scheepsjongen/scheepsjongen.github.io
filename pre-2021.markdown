...
<script>
    var quizEngine = null;
    var quizUrl = '/quiz/pre-2021-test.xml';
    $(function () {
    ...
    <div id="jsQuizEngine">
        <section data-bind="visible: !quizStarted()">
            <div class="jumbotron">
                    ...
                    <div class="container-text">
                        <h1>Тест судноводія Pre 2021</h1>
                        <p>Тест, що був до літа 21-го року</p>
        ...
        <section class="container-text">
            ...
            <section class="score" data-bind="visible: quizComplete">
                ...
                <a href="https://scheepsjongen.github.io/pre-2021" class="btn btn-primary btn-lg">Наново</a>
